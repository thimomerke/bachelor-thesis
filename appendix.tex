 ...
 \mbox{} \begin{center}
    ...
    \captionsetup{margin=0cm}
         \begin{minipage}{1.2\linewidth}
            ...
            \captionof{figure}[Overview of the potential of CDR approaches mentioned in literature]{Overview of the potential of CDR approaches mentioned in literature. The blue lines represent the average values.}
         \vspace{0.2cm}
         \label{fig:xx}
         \end{minipage}
    \end{sideways}
